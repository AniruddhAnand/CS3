...
public final class Picture implements ActionListener {
   ...
   /**
    ...
    public static void main(String[] args) {
        Picture pic = new Picture("mystery.png");//args[0]);
        System.out.printf("%d-by-%d\n", pic.width(), pic.height());
        pic.show();
//        PhotoMagic.transform(pic,new LFSR("01101000010100010000",16));
//        pic.show();
//        PhotoMagic.transform(pic,new LFSR("01101000010100010000",16));
//        pic.show();
        Picture pic2 = PhotoMagicDeluxe.transform(pic,"OPENSESAME",58);
        pic2.show();
        Picture pic3 = PhotoMagicDeluxe.transform(pic,"OPENSESAME",58);
        pic3.show();
    }
