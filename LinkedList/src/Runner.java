public class Runner
{
	...
	{
		MyLinkedList a = new MyLinkedList<Integer>();
		MyLinkedList b = new MyLinkedList<Integer>(20);
		...
		for (Object o:list) { //test isEmpty() and remove() methods
			System.out.print(o + " "); //should print list in order
		}
		System.out.println();
