...
public class Tile 
{
	public enum TileType {INVALID, FLOOR, LAVA, WATER, FOREST, GRASS, MOUNTAIN, WALL, PORTAL, LOOT}
	...
	public Tile(String code)
	{
		...
		else if(code.equals("P")) type = TileType.PORTAL;
		else if(code.equals("V")) type = TileType.LOOT;
	}
	...
	public void draw(int x, int y)
	{
		...
		if (lit)
		{
			switch (type)
			{
				case FLOOR:		StdDraw.picture(drawX, drawY, "floor.jpg",32,32); 	break;
				case LAVA:		StdDraw.picture(drawX, drawY, "lava.jpg",32,32); 			break;
				case WATER:		StdDraw.picture(drawX, drawY, "water.jpg",32,32);     	break;
				case GRASS:		StdDraw.picture(drawX, drawY, "grasslands.jpg",32,32); 	break;
				case FOREST:	StdDraw.picture(drawX, drawY, "forest.jpg",32,32);    	break;
				case MOUNTAIN:	StdDraw.picture(drawX, drawY, "mountains.jpg",32,32); 	break;
				case WALL:		StdDraw.picture(drawX, drawY, "stonewall.jpg",32,32); 	break;
				case PORTAL: StdDraw.picture(drawX,drawY,"door.gif",32,32); break;
				case LOOT: StdDraw.picture(drawX, drawY,"chest.gif",32,32); break;
			    default:                                            				break;										
			}			
		}
		else
		{
			StdDraw.picture(drawX, drawY, "blank.jpg");
		}
	}
	public boolean isPortal(){
		return type==TileType.PORTAL;
	}
	// Test method
	/**
