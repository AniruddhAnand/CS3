	...
	public static void main(String [] args)
	{
		...
		final Runnable runnable = new Runnable() {
			...
			public void run() {
				...
				{
					StdDraw.clear();
					StdDraw.setPenColor(Math.round(countdownStarter/100.0)<=2?StdDraw.RED:StdDraw.BLACK);
					StdDraw.setFont(new Font("SansSerif", Font.BOLD, Math.round(countdownStarter/100.0)<=2?30:22));
					StdDraw.text(.5,.9,Math.round(countdownStarter/100.0)+"");
					countdownStarter--;
