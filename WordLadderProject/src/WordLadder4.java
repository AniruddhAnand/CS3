...
public class WordLadder4 {
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter out = new PrintWriter("solutions.txt");
        st = new StringTokenizer(f.readLine());
...
//                out.println(ladder(start, end, dictionary));
                out.println(sol.ladderLength(start,end,dictionary.get(start.length())));
                st = new StringTokenizer(f.readLine());
            }
        } catch (Exception e) {
        }
    ...
    public static LinkedList<String> getSwitch(String word, HashMap<Integer, LinkedList<String>> dictionary, HashSet<String> allWords) {
